...
=== 절차
. JdbcProductRepository 클래스의 테스트 클래스를 작성합시다.
테스트용  SQL 파일은 src/test/resources 아래의 JdbcProductRepositoryTest.sql에 준비되어 있습니다.
아래에 제시된 JdbcProductRepository 클래스의 메서드를 테스트해 보세요.
